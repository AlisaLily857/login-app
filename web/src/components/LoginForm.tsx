...
const LoginForm: React.FC<LoginFormProps> = ({ onSubmit, onForgotPassword, onGoogleLogin }) => {
    ...
    <div className="login-form-container">
      <form className="login-form" onSubmit={handleSubmit}>
        ...
        <div className="form-options">
          <label className="remember-me"><input type="checkbox" /><span>记住我</span></label>
          <button type="button" className="forgot-password" onClick={onForgotPassword}>忘记密码？</button>
        </div>
        ...
        <div className="signup-link">还没有账号？<a href="#">立即注册</a></div>
      </form>
    </div>
  );
};
